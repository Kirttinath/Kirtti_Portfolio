...
const getSkillIcon = (skill: string) => {
    const iconMap: Record<string, React.ReactNode> = {
        ...
        "Tailwind CSS": <SiTailwindcss className="h-4 w-4 text-cyan-500" />,
        GraphQL: <SiGraphql className="h-4 w-4 text-pink-600" />,

        // Backend
        MongoDB: <SiMongodb className="h-4 w-4 text-green-500" />,
        "Express.js": (
            <SiExpress className="h-4 w-4 text-black dark:text-white" />
        ),
        ...
        "HTML/CSS": (
            <div className="flex gap-1">
                <SiHtml5 className="h-4 w-4 text-orange-500" />
                <SiCss3 className="h-4 w-4 text-blue-500" />
            </div>
        ),
        JavaScript: <SiJavascript className="h-4 w-4 text-yellow-500" />,
        Sass: <SiCss3 className="h-4 w-4 text-pink-500" />,
    };
                ...
                <div className="flex flex-col gap-12">
                    <div className="space-y-4 text-center">
                        ...
                        <p className="text-muted-foreground max-w-2xl mx-auto">
                            My professional journey and the impactful roles I've
                            held.
                        </p>
                    </div>
